...
func TestDispatch_Local_HandlerError(t *testing.T) {
	localReg := newMockLocalRegistry()
	localReg.Register("failing", func(ctx context.Context, args map[string]any) (any, error) {
...
func TestDispatch_Local_UsesBackendName(t *testing.T) {
	called := false
	localReg := newMockLocalRegistry()
	localReg.Register("specific-handler", func(ctx context.Context, args map[string]any) (any, error) {
		called = true
		return "ok", nil
	})
